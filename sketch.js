  ...
  function switchImg() {
    var random_animation = Math.round(random(1,4));
      switch(random_animation) {
        case 1: enemy.animation = loadImage("car1.png");
                break;
        case 2: enemy.animation = loadImage("car2.png");
                break;
        case 3: enemy.animation = loadImage("car3.png");
                break;
        case 4: enemy.animation = loadImage("car4.png");
                break;
        default: break;
      }
  }
